...
namespace Business.Shared.Models.CertificadoDigital
{
    public sealed class CertificadoDigital
    {
        ...
        public CertificadoDigital(PdfPKCS7 pkcs7) : this(new X509Certificate2(pkcs7.GetSigningCertificate().GetEncoded())) {
            Pkcs7SignDate = pkcs7.GetSignDate();
        }
